            ...
            <div className="relative main-container flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 py-20 md:py-32 z-10">
                ...
                <div className="group relative w-full lg:w-1/2">
                    <div className="relative z-10 overflow-hidden rounded-2xl shadow-2xl transition-transform duration-500 group-hover:-translate-y-2">
                        ...
                        />
                        <div className="absolute inset-0 bg-linear-to-t from-[#003366]/60 to-transparent"></div>
                        <div className="absolute bottom-0 left-0 p-8">
                            <h3 className="text-3xl text-white font-bold">15+ Years Excellence</h3>
                        </div>
                    </div>
                    {/* Decorative shapes using brand colors */}
                    <div className="absolute -top-10 -left-10 w-40 h-40 bg-[#003366]/5 rounded-full -z-10"></div>
                    <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-gray-200 rounded-full -z-10"></div>
                </div>

                {/* Right: Content */}
                <div className="w-full lg:w-1/2">
                    <div className="inline-block px-4 py-1 bg-[#003366]/10 text-[#003366] font-bold text-sm tracking-widest uppercase rounded-full mb-6">
                        Our Legacy
                    </div>

                    <h2 className="text-3xl md:text-5xl font-extrabold text-[#003366] leading-tight mb-8">
                        Trusted Partners for Your <br />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-[#003366] to-[#00AEEF]">Next Adventure</span>
                    </h2>

                    <p className="text-[#545454] text-lg mb-8 leading-relaxed">
                        If you are looking for a dependable and professional travel partner, Rihla Access Travels is your premier choice. With years of industry expertise, we have built a reputation for excellence and integrity in every journey we plan.
                    </p>

                    <div className="space-y-6">
                        <div className="flex gap-4 p-4 rounded-xl bg-white border-l-4 border-[#003366] shadow-sm">
                            <div className="shrink-0 w-12 h-12 flex items-center justify-center bg-[#003366]/5 rounded-lg">
                                <svg className="w-6 h-6 text-[#003366]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </div>
                            <div>
                                <h4 className="text-[#003366] font-bold text-lg">Expert Travel Solutions</h4>
                        ...
                        <div className="flex gap-4 p-4 rounded-xl bg-white border-l-4 border-[#545454] shadow-sm">
                            ...
                            <div>
                                <h4 className="text-[#003366] font-bold text-lg">Personalized Support</h4>
                                <p className="text-sm text-[#545454]">We focus on individual customer needs, providing one-on-one assistance always.</p>
                            </div>
                        </div>
                    </div>

                    <button className="group mt-10 flex items-center gap-3 bg-[#003366] text-white px-8 py-4 rounded-full font-bold hover:bg-[#002855] transition-all shadow-xl hover:shadow-2xl">
                        Discover More
