    ...
    color === "blue"
      ? {
          background: isChecked
            ? "bg-linear-to-r from-brand-500 to-brand-600 shadow-lg shadow-brand-500/30"
      ...
      : {
          background: isChecked
            ? "bg-linear-to-r from-gray-700 to-gray-800 dark:from-gray-600 dark:to-gray-700 shadow-lg"
