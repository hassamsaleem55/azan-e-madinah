...
const Input: React.FC<InputProps> = ({
  ...
  const baseClasses = 'w-full h-11 sm:h-12 px-3 py-2.5 sm:px-4 sm:py-3 text-sm font-medium rounded-xl border-2 transition-all duration-300';
  const normalClasses = 'dark:bg-gray-900 text-gray-900 dark:text-white border-gray-200 dark:border-gray-700';
