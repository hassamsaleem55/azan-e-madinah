...
export const generateBookingPDF = async (booking: any): Promise<void> => {
    ...
    //                         <td style="padding: 10px 12px; border: 1px solid #ddd; text-align: center; font-weight: bold; font-size: 12px;">PF 784</td>
    //                         <td style="padding: 10px 12px; border: 1px solid #ddd; text-align: center; font-size: 12px;">
    //                             <div style="font-weight: bold;">11:20</div>
    //                             <div style="font-size: 10px;">${formatDate(booking.departureDate)}</div>
    //                         </td>
    //                         <td style="padding: 10px 12px; border: 1px solid #ddd; text-align: center; font-size: 12px;">
    //                             <div style="font-weight: bold;">14:00</div>
    //                             <div style="font-size: 10px;">${formatDate(booking.departureDate)}</div>
    //                         </td>
    //         <!-- Passenger Details -->
    //         <div style="margin-bottom: 25px;">
    ...
    //                         <th style="padding: 9px 10px; text-align: left; border: 1px solid #0369a1; font-weight: bold; font-size: 11px;">Passport #</th>
    ...
    //                 </thead>
    //                 <tbody>
    //                     ${booking.passengers && booking.passengers.length > 0 ? booking.passengers.map((p: any, idx: number) => `
    //                         <tr>
    //                             <td style="padding: 9px 10px; border: 1px solid #ddd; text-align: left; font-size: 11px;">${idx + 1}</td>
    //                             <td style="padding: 9px 10px; border: 1px solid #ddd; text-align: left; font-size: 11px;">${p.title + p.givenName + p.surName || 'N/A'}</td>
    //                             <td style="padding: 9px 10px; border: 1px solid #ddd; text-align: left; font-size: 11px;">${p.passport || 'N/A'}</td>
    ...
    //             <p style="margin: 6px 0;">Generated on: ${new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' } as any)} ${new Date().toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit' } as any)}</p>
    //         </div>
    //     </div>
    // `;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding:9px; font-size:11px; text-align:right;">
                        PKR ${(booking.pricing.grandTotal / (booking.passengers?.length || 1)).toLocaleString()}
                    </td>
                </tr>
                `).join('')}
